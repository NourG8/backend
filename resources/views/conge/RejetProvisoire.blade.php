...
<head>
    ...
    <title>Response to leave request</title>
                        ...
                        <img width="60" src="{{asset('assets/logo.png')}}" title="logo" alt="logo">
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">You have an answer on your leave request</h1>
                                        <span
                                        ...
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            ...
                                            @foreach($conge['dates'] as $index=>$date)
                                                {{ $date }}
                                                @if($index < count($conge['dates'])-1 )
                                                     ,
                                                @endif
                                            @endforeach .
